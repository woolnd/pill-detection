...
| 2 | 0.61084 | rahui_ep50_img1280_batch4_aihubdata_boxcls_v2 | 김라희 | 0.9924 | 09-19 05:07 | 0.60543 조합(img1280·batch4·warmup1.5·close_mosaic5) 그대로 + box12.0·cls1.0 재추가 (단일 변수 격리 테스트) |
| 3 | 0.61074 | jw_ep30_img960_batch8_lr0.001_cos_lr_aihubdata | 엄재웅 | 0.9929 | 09-18 11:52 | epochs: 30 / imgsz: 960 / batch: 8 / lr: 0.001 / cos_lr: True / warmup 1 · close_mosaic 3 (100 epoch 와 같은 비율) / AI Hub 조합 데이터 추가 (train 10,394장, 118종) |
| 4 | 0.60672 | rahui_ep50_img1280_batch4_aihubdata_clahe | 김라희 | 0.9763 | 09-19 18:09 | v2(box=12.0/cls=1.0) 설정 그대로 유지, 데이터 전처리에 CLAHE(LAB L채널 대비 보정) 추가 — 각인 저대비 클래스(35206 등) 개선 테스트 |
| 5 | 0.60543 | rahui_ep50_img1280_batch4_aihubdata_boxcls | 김라희 | 0.9856 | 09-18 23:14 | rahui_ep50_img1280_batch4_aihubdata_boxcls,후처리코드제외 |
<!-- 실험그래프 끝 -->
